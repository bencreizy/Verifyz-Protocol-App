...
export default function App() {
  return (
    <div className="min-h-screen text-white relative bg-verifyz-gradient">
      ...
      <div className="absolute inset-0" style={{backgroundImage: "url('/attached_assets/circuit_board_cyan_upscaled_4k_1757982811493.png')", backgroundSize: '120% 120%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', opacity: '0.12'}}></div>
